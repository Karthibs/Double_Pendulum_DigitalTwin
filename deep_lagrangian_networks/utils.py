...
"""
def load_dataset(n_characters=3, filename="data/data/character_data.pickle", test_label=("e", "q", "v")):
...
def load_dataset(filename="data/real_data/data/character_data.pickle"):
    ...
    test_idx = [i for i, label in enumerate(data["labels"]) if label == "test_labels"]
    ...
    for i in range(len(data["labels"])):
        ...
        elif current_label == "train_labels":
